...
## Legacy PDF-First Code

The earlier PDF-first implementation is kept for reference only:

```text
versions/legacy_pdf_first/
```

Use the active Docling JSON extractor for new work.
